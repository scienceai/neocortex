...
describe('Layer: advanced activations', function() {
  ...
  describe('leaky ReLU (alpha = 0.3)', function() {
    it('should output the correct values', (done) => {
      ...
      let expected = pack(arrayType, [1.0, 0.0, -0.18000000715255737, 0.8999999761581421, 2.0, -0.36000001430511475, 0.4000000059604645, -0.9000000357627869]);
  ...
  describe('parametric ReLU', function() {
    it('should output the correct values', (done) => {
      ...
      let expected = pack(arrayType, [1.0, 0.0, -0.24000000953674316, 0.8999999761581421, 2.0, -1.0800000429153442, 0.4000000059604645, 0.0]);
  ...
  describe('parametric softplus', function() {
    it('should output the correct values', (done) => {
      ...
      let expected = pack(arrayType, [0.06931471824645996, 0.013862943276762962, 0.10531298071146011, 0.5530087351799011, 4.0001678466796875, 0.0022281166166067123, 2.4868361949920654, 0.0]);
  ...
  describe('thresholded linear (theta = 1.0)', function() {
    it('should output the correct values', (done) => {
      ...
      let expected = pack(arrayType, [1.0, 0.0, 0.0, 0.0, 2.0, -1.2000000476837158, 0.0, -3.0]);
  ...
  describe('thresholded ReLU (theta = 1.0)', function() {
    it('should output the correct values', (done) => {
      ...
      let expected = pack(arrayType, [0.0, 0.0, 0.0, 0.0, 2.0, 0.0, 0.0, 0.0]);
